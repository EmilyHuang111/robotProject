...
# Default positions
DEFAULT_FORWARD_ANGLE = 90  # Neutral position
DEFAULT_BACKWARD_ANGLE = 90  # Neutral position

# Movement angles
FORWARD_ANGLE = 60  # Move leg forward
BACKWARD_ANGLE = 120  # Move leg backward

def setup():
    """Initialize default servo positions."""
    print("Setting all servos to initial positions...")
    set_all_servos(DEFAULT_FORWARD_ANGLE)
    print("Servos are in their initial positions.")
...
def set_all_servos(angle):
    ...
    time.sleep(1)  # Allow servos to reach initial positions
